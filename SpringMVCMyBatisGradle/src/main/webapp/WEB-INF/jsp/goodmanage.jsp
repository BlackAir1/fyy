		...
		<tr valign="top">
			<td height="20">
				<table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
					<tr class="main_trbg_tit" align="center">
					    ...
					    <td>数量</td>
					    <td>出版社</td>
					    <td><a href="${pageContext.request.contextPath }/addGood">添加书籍</a></td>
					    <td>修改</td>
					    <td>删除</td>
					</tr>
			<c:forEach items="${requestScope.book}" var="good" varStatus="status">
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					...
					<td>${good.count}</td>
					<td>${good.factory}</td>
					<td><a href="${pageContext.request.contextPath }/addGood">添加</a></td>
					<td><a href="${pageContext.request.contextPath }/goUpdateGoods/${good.id }">修改</a></td>
					 <td><a href="${pageContext.request.contextPath }/deleteGoods/${good.id }">删除</a></td>
				</tr>
			</c:forEach>
		  </table>
		</td>
