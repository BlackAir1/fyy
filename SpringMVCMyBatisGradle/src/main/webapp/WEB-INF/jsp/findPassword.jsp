	...
	<div class="web_login" id="web_login">
        ...
        <div class="login-box">
			<div class="login_form">
				...
				<form action="find" name="customerLogin" accept-charset="utf-8" id="login_form" class="loginForm" method="post"><input type="hidden" name="did" value="0"/>
	                ...
	                <div class="uinArea" id="uinArea">
		                ...
		                <div class="inputOuter" id="uArea">
		                    <input type="text" id="u" name="email" class="inputstyle"  placeholder="验证邮箱"/>
		                </div>
	                </div>
