...
public interface BookMapper {
	...
	@Insert("insert into tb_book(name,price,count,factory,author,image) values(#{name},#{price},#{count},#{factory},#{author},#{image})")
	...
	@Update("update tb_book set name=#{name},price=#{price},count=#{count},factory=#{factory},#{author},image=#{image} where id=#{id}")
